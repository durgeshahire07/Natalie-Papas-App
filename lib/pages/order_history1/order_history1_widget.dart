...
import 'order_history1_model.dart';
export 'order_history1_model.dart';

class OrderHistory1Widget extends StatefulWidget {
  const OrderHistory1Widget({super.key});

  @override
  State<OrderHistory1Widget> createState() => _OrderHistory1WidgetState();
}

class _OrderHistory1WidgetState extends State<OrderHistory1Widget> {
  late OrderHistory1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderHistory1Model());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final orderHistory1GetOrderHistoryAPIResponse = snapshot.data!;
