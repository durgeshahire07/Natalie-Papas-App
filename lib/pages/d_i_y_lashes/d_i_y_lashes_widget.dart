...
import 'd_i_y_lashes_model.dart';
export 'd_i_y_lashes_model.dart';

class DIYLashesWidget extends StatefulWidget {
  const DIYLashesWidget({super.key});

  @override
  State<DIYLashesWidget> createState() => _DIYLashesWidgetState();
}

class _DIYLashesWidgetState extends State<DIYLashesWidget> {
  late DIYLashesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DIYLashesModel());
  }
